    ...
    return (
        <header id='profile' className='flex flex-col justify-center items-center mb-8 mt-4 z-10
            ...
            <div className='relative '>
                ...
                />
                <a className={`bg-accent-dark text-accent-hover size-16 md:size-20 flex items-center justify-center rounded-full hover:scale-120 transition-transform absolute bottom-0 right-2 md:right-4 animate-slide-in-top`}
                    href={DIGITAL_CARD}
