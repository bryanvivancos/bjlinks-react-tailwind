...
const Project = ({ url, skillName, name, skill, ico, span, background}) => {
    return (
        ...
        className={`relative rounded-3xl overflow-hidden border flex items-start hover:scale-105 hover:contrast-125 transition p-7 min-h-28 col-span-1 md:col-span-${span} group ${background}`}>
