...
const Navbar = () => {
    ...
    return (
        <>
            {/* Fixed Navbar */}
            <nav className={`fixed top-0 left-0 right-0 z-[100] px-6 md:px-12 py-6 mt-2 md:mt-4 rounded-full w-[95%] mx-auto ${!isOpen && 'backdrop-blur-md bg-black/40 shadow-lg'}`}>
